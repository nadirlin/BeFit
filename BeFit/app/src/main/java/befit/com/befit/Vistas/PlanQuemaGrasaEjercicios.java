...
public class PlanQuemaGrasaEjercicios extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plan_quema_grasa_ejercicios);

        listaGuiaEjercicios = new ArrayList<>();
        recyclerGuiaEjercicios = (RecyclerView) findViewById(R.id.recyclerIdDiasPlanqgej);
    ...
    private void llenarDiaUno(){
        String uno[] = getResources().getStringArray(R.array.diaunopg);
    ...
    private void llenarDiaDos(){
        String dos[] = getResources().getStringArray(R.array.diadospg);
    ...
    private void llenarDiaTres(){
        String tres[] = getResources().getStringArray(R.array.diatrespg);
    ...
    private void llenarDiaCuatro(){
        String cuatro[] = getResources().getStringArray(R.array.diacuatropg);
    ...
    private void llenarDiaCinco(){
        String cinco[] = getResources().getStringArray(R.array.diacincopg);
    ...
    private void llenarDiaSeis(){
        String seis[] = getResources().getStringArray(R.array.diaseispg);
