...
public class EjercicioPiernas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ejercicio_piernas);

        r = (RecyclerView) findViewById(R.id.idRecyclerPie);
        ...
        a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(index == 0){
                    Intent i = new Intent(EjercicioPiernas.this, PlantillaEjerciciosPierna.class);
                    i.putExtra("index", 0);
                    startActivity(i);
                }else if(index == 1){
                    Intent i = new Intent(EjercicioPiernas.this, PlantillaEjerciciosPierna.class);
    ...
    private void llenarGuiaEjPiernas(){
        String ejercicios[] = getResources().getStringArray(R.array.ejpiernas);
