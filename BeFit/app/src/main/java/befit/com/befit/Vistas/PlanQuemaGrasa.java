...
public class PlanQuemaGrasa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plan_quema_grasa);
        listaGuiaEjercicios = new ArrayList<>();
        recyclerGuiaEjercicios = (RecyclerView) findViewById(R.id.recyclerIdDiasPlanqg);
        ...
        a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(index == 0){
                    Intent i = new Intent(PlanQuemaGrasa.this, PlanQuemaGrasaEjercicios.class);
                    i.putExtra("index", 0);
                    startActivity(i);
                }else if(index == 1){
                    Intent i = new Intent(PlanQuemaGrasa.this, PlanQuemaGrasaEjercicios.class);
