...
public class EjercicioEspalda extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ejercicio_espalda);

        r = (RecyclerView) findViewById(R.id.idRecyclerEsp);
        ...
        a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(index == 0){
                    Intent i = new Intent(EjercicioEspalda.this, PlantillaEjerciciosEspalda.class);
                    i.putExtra("index", 0);
                    startActivity(i);
                }else if(index == 1){
                    Intent i = new Intent(EjercicioEspalda.this, PlantillaEjerciciosEspalda.class);
    ...
    private void llenarGuiaEjEspalda(){
        String ejercicios[] = getResources().getStringArray(R.array.ejespalda);
