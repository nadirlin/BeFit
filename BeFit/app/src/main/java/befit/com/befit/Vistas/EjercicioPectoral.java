...
public class EjercicioPectoral extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ejercicio_pectoral);

        r = (RecyclerView) findViewById(R.id.idRecyclerPec);
        r.setLayoutManager(new GridLayoutManager(this, 1));

        listaGuiaEjercicios = new ArrayList<>();

        llenarGuiaEjPectoral();
        ...
        a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(index == 0){
                    Intent i = new Intent(EjercicioPectoral.this, PlantillaEjercicios.class);
                    i.putExtra("index", 0);
                    startActivity(i);
                }else if(index == 1){
                    Intent i = new Intent(EjercicioPectoral.this, PlantillaEjercicios.class);
    ...
    private void llenarGuiaEjPectoral(){
        String pectorales[] = getResources().getStringArray(R.array.ejpectoral);

        for(String p : pectorales){
