...
public class EjercicioTriceps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ejercicio_triceps);

        r = (RecyclerView) findViewById(R.id.idRecyclerTri);
        ...
        a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(index == 0){
                    Intent i = new Intent(EjercicioTriceps.this, PlantillaEjerciciosTriceps.class);
                    i.putExtra("index", 0);
                    startActivity(i);
                }else if(index == 1){
                    Intent i = new Intent(EjercicioTriceps.this, PlantillaEjerciciosTriceps.class);
    ...
    private void llenarGuiaEjTriceps(){
        String ejercicios[] = getResources().getStringArray(R.array.ejtriceps);
