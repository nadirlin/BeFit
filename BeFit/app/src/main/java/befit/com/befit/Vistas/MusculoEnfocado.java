...
public class MusculoEnfocado extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerGuiaEjercicios = (RecyclerView) findViewById(R.id.recyclerIdMusEnf);
        ...
        a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(index == 0){
                    Intent i = new Intent(MusculoEnfocado.this, MusculoEnfocadoEjercicios.class);
                    i.putExtra("index", 0);
                    startActivity(i);
                }/*else if(index == 1){
    ...
    private void llenarDias(){
        String strings[] = getResources().getStringArray(R.array.guiaejercicios);
