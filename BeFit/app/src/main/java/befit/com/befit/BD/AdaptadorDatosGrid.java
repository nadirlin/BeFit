...
/**
 * Created by Usuariopc on 1/11/2017.
 */

public class AdaptadorDatosGrid extends RecyclerView.Adapter<AdaptadorDatosGrid.VistaHolderGuiaEjercicios>
        implements View.OnClickListener {

    ArrayList<GuiaEjerciciosRw> listaGuiaEjercicios;
    private View.OnClickListener listener;

    public AdaptadorDatosGrid(ArrayList<GuiaEjerciciosRw> listaGuiaEjercicios) {
        this.listaGuiaEjercicios = listaGuiaEjercicios;
    }

    @Override
    public AdaptadorDatosGrid.VistaHolderGuiaEjercicios onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_ejercicios, null, false);
        view.setOnClickListener(this);
        return new AdaptadorDatosGrid.VistaHolderGuiaEjercicios(view);
    }

    @Override
    public void onBindViewHolder(AdaptadorDatosGrid.VistaHolderGuiaEjercicios holder, int position) {
