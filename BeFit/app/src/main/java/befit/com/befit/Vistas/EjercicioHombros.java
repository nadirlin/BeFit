...
public class EjercicioHombros extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ejercicio_hombro);

        r = (RecyclerView) findViewById(R.id.idRecyclerHom);
        ...
        a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(index == 0){
                    Intent i = new Intent(EjercicioHombros.this, PlantillaEjerciciosHombro.class);
                    i.putExtra("index", 0);
                    startActivity(i);
                }else if(index == 1){
                    Intent i = new Intent(EjercicioHombros.this, PlantillaEjerciciosHombro.class);
    ...
    private void llenarGuiaEjHombro(){
        String ejercicios[] = getResources().getStringArray(R.array.ejhombros);
